...
// Edge Impulse continuous microphone example adapted for ESP32-S3 Super Mini
// and the FireAlarm_Detector_ML model.
...
{
    Serial.begin(115200);
    // Do not block waiting for Serial Monitor, so the device works on external power too
    delay(100);
    ei_printf("Edge Impulse Inferencing Demo (ESP32-S3 Super Mini)\n");
